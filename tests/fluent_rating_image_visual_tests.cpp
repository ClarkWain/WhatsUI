...
void render(const std::string& outputPath, float scale)
{
    ...
    try {
        ...
        expect(pixelIs(pixels, width, scale, 80, 120,
                        wui::theme().colors.neutralBackground2.rest),
