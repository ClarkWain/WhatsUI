...
void testRowMeasureWithGap()
{
    wui::RowNode row;
    row.setGap(10.0f);
    row.appendChild(std::make_unique<wui::SpacerNode>(wui::SizeF{20.0f, 30.0f}));
    row.appendChild(std::make_unique<wui::SpacerNode>(wui::SizeF{40.0f, 20.0f}));
...
void testRowMeasureWithPadding()
{
    ...
    row.appendChild(std::make_unique<wui::SpacerNode>(wui::SizeF{50.0f, 40.0f}));
...
void testRowGapSkipsZeroSizeChildren()
{
    wui::RowNode row;
    row.setGap(10.0f);
    auto first = std::make_unique<wui::SpacerNode>(wui::SizeF{20.0f, 20.0f});
    auto hidden = std::make_unique<wui::SpacerNode>();
    auto last = std::make_unique<wui::SpacerNode>(wui::SizeF{30.0f, 20.0f});
...
void testRowCollapsedGapEdgesAndFlexContract()
{
    wui::RowNode row;
    row.setGap(5.0f);
    auto leading = std::make_unique<wui::SpacerNode>();
    auto first = std::make_unique<wui::SpacerNode>(wui::SizeF{10.0f, 10.0f});
    auto middleA = std::make_unique<wui::SpacerNode>();
    auto middleB = std::make_unique<wui::SpacerNode>();
    auto last = std::make_unique<wui::SpacerNode>(wui::SizeF{10.0f, 10.0f});
    auto trailing = std::make_unique<wui::SpacerNode>();
    auto* lastPtr = last.get();
    ...
    wui::RowNode flexRow;
    flexRow.setGap(5.0f);
    auto fixed = std::make_unique<wui::SpacerNode>(wui::SizeF{10.0f, 10.0f});
    auto flex = std::make_unique<wui::SpacerNode>();
    flex->setFlex(1.0f);
...
{
    wui::RowNode row;
    auto spacer1 = std::make_unique<wui::SpacerNode>(wui::SizeF{50.0f, 20.0f});
    auto flex1 = std::make_unique<wui::SpacerNode>();
    flex1->setFlex(1.0f);
    auto flex2 = std::make_unique<wui::SpacerNode>();
    flex2->setFlex(2.0f);

    wui::SpacerNode* pFlex1 = flex1.get();
    wui::SpacerNode* pFlex2 = flex2.get();
...
void testRowLayoutAlignCenter()
{
    ...
    auto child = std::make_unique<wui::SpacerNode>(wui::SizeF{30.0f, 20.0f});
    wui::SpacerNode* pChild = child.get();
...
{
    wui::RowNode row;
    row.appendChild(std::make_unique<wui::SpacerNode>(wui::SizeF{500.0f, 30.0f}));
...
void testColumnMeasureWithGap()
{
    wui::ColumnNode col;
    col.setGap(5.0f);
    col.appendChild(std::make_unique<wui::SpacerNode>(wui::SizeF{20.0f, 30.0f}));
    col.appendChild(std::make_unique<wui::SpacerNode>(wui::SizeF{40.0f, 20.0f}));
    col.appendChild(std::make_unique<wui::SpacerNode>(wui::SizeF{10.0f, 15.0f}));
...
void testColumnMeasureWithPadding()
{
    ...
    col.appendChild(std::make_unique<wui::SpacerNode>(wui::SizeF{60.0f, 50.0f}));
...
{
    wui::ColumnNode column;
    column.setGap(10.0f);
    auto first = std::make_unique<wui::SpacerNode>(wui::SizeF{20.0f, 20.0f});
    auto hidden = std::make_unique<wui::SpacerNode>();
    auto last = std::make_unique<wui::SpacerNode>(wui::SizeF{20.0f, 30.0f});
    auto* hiddenPtr = hidden.get();
    auto* lastPtr = last.get();
...
void testColumnCollapsedGapEdgesAndDynamicVisibility()
{
    ...
    auto leading = std::make_unique<wui::SpacerNode>();
    auto first = std::make_unique<wui::SpacerNode>(wui::SizeF{10.0f, 10.0f});
    auto middle = std::make_unique<wui::SpacerNode>();
    auto last = std::make_unique<wui::SpacerNode>(wui::SizeF{10.0f, 10.0f});
    auto trailing = std::make_unique<wui::SpacerNode>();
...
{
    wui::ColumnNode col;
    auto fixed = std::make_unique<wui::SpacerNode>(wui::SizeF{30.0f, 50.0f});
    auto flex1 = std::make_unique<wui::SpacerNode>();
    flex1->setFlex(1.0f);
    auto flex2 = std::make_unique<wui::SpacerNode>();
    flex2->setFlex(3.0f);
...
void testColumnLayoutAlignCenter()
{
    ...
    auto child = std::make_unique<wui::SpacerNode>(wui::SizeF{40.0f, 30.0f});
    wui::SpacerNode* pChild = child.get();
...
void testContainerSingleChild()
{
    ...
    auto child = std::make_unique<wui::SpacerNode>(wui::SizeF{80.0f, 60.0f});
    wui::SpacerNode* pChild = child.get();
...
void testRowLayoutAlignBaseline()
{
    ...
    auto large = std::make_unique<wui::TextNode>("Title");
    large->setFontSize(24.0f);
    large->setLineHeight(32.0f);
    auto small = std::make_unique<wui::TextNode>("Meta");
...
void testContainerOverlaysAllChildren()
{
    ...
    auto small = std::make_unique<wui::SpacerNode>(wui::SizeF{30.0f, 40.0f});
    auto large = std::make_unique<wui::SpacerNode>(wui::SizeF{80.0f, 60.0f});
    auto* pSmall = small.get();
    auto* pLarge = large.get();
...
void testImageIntrinsicMeasurement()
{
    ...
    wui::ImageNode image(std::move(pixels), 3, 2);
...
void testTextWrapMaxLinesEllipsisAndUnicode()
{
    ...
    wui::TextNode multilingual("\xE4\xBD\xA0\xE5\xA5\xBD\xE4\xB8\x96\xE7\x95\x8C");
    ...
    auto built = std::move(wui::Text("builder").wrap().maxLines(3).ellipsis()).build();
    auto* builtText = dynamic_cast<wui::TextNode*>(built.get());
...
{
    wui::BoxNode container;
    auto back = std::make_unique<wui::ColumnNode>();
    back->appendChild(std::make_unique<wui::TextNode>("Back"));
    auto front = std::make_unique<wui::RowNode>();
    auto image = std::make_unique<wui::ImageNode>(std::vector<unsigned char>(4u, 255u), 1, 1);
...
void testRowGapWithFlex()
{
    wui::RowNode row;
    row.setGap(10.0f);
    auto fixed1 = std::make_unique<wui::SpacerNode>(wui::SizeF{20.0f, 30.0f});
    auto flex = std::make_unique<wui::SpacerNode>();
    flex->setFlex(1.0f);
    auto fixed2 = std::make_unique<wui::SpacerNode>(wui::SizeF{30.0f, 30.0f});

    wui::SpacerNode* pFixed2 = fixed2.get();
...
void testContainerContentAlignment()
{
    ...
    auto child = std::make_unique<wui::SpacerNode>(wui::SizeF{20.0f, 10.0f});
...
void testContainerExplicitSize()
{
    ...
    container.appendChild(std::make_unique<wui::SpacerNode>(wui::SizeF{10.0f, 10.0f}));
    const auto size = container.measure({0.0f, 200.0f, 0.0f, 200.0f});
...
void testNestedLayoutSnapshotAndDirtyClear()
{
    ...
    column->setGap(4.0f);
    auto first = std::make_unique<wui::SpacerNode>(wui::SizeF{30.0f, 20.0f});
    auto row = std::make_unique<wui::RowNode>();
    row->setGap(3.0f);
    auto left = std::make_unique<wui::SpacerNode>(wui::SizeF{10.0f, 8.0f});
    auto right = std::make_unique<wui::SpacerNode>(wui::SizeF{15.0f, 8.0f});
...
void testConstrainedNestedLayoutSnapshot()
{
    ...
    row.setGap(6.0f);
    auto fixed = std::make_unique<wui::SpacerNode>(wui::SizeF{20.0f, 10.0f});
    auto flex = std::make_unique<wui::ColumnNode>();
    flex->setFlex(1.0f);
    flex->setAlign(wui::Alignment::Stretch);
    auto inner = std::make_unique<wui::SpacerNode>(wui::SizeF{5.0f, 7.0f});
